WatchedValue object is returned by some methods of the [Trading Terminal](Trading-Terminal.md). Using this object you can get/set some value and be notified when the value is changed.
